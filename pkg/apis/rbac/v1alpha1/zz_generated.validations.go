...
func Validate_ClusterRole(
	...
	{ // field rbacv1alpha1.ClusterRole.Rules
		fn := func(
			fldPath *field.Path,
			obj, oldObj []rbacv1alpha1.PolicyRule,
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1alpha1.ClusterRole) []rbacv1alpha1.PolicyRule {
				return oldObj.Rules
			})
...
func Validate_ClusterRoleBinding(
	...
	{ // field rbacv1alpha1.ClusterRoleBinding.Subjects
		fn := func(
			fldPath *field.Path,
			obj, oldObj []rbacv1alpha1.Subject,
			oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update {
				if equality.Semantic.DeepEqual(obj, oldObj) {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1alpha1.ClusterRoleBinding) []rbacv1alpha1.Subject {
	...
	{ // field rbacv1alpha1.ClusterRoleBinding.RoleRef
		fn := func(
			fldPath *field.Path,
			obj, oldObj *rbacv1alpha1.RoleRef,
			oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1alpha1.ClusterRoleBinding) *rbacv1alpha1.RoleRef {
...
func Validate_PolicyRule(
	...
	{ // field rbacv1alpha1.PolicyRule.Verbs
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1alpha1.PolicyRule) []string {
				return oldObj.Verbs
			})
...
func Validate_Role(
	...
	{ // field rbacv1alpha1.Role.Rules
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1alpha1.Role) []rbacv1alpha1.PolicyRule {
				return oldObj.Rules
			})
		errs = append(errs, fn(fldPath.Child("rules"), obj.Rules, oldVal, oldObj != nil)...)
	}
...
func Validate_RoleBinding(
	...
	{ // field rbacv1alpha1.RoleBinding.Subjects
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1alpha1.RoleBinding) []rbacv1alpha1.Subject {
				return oldObj.Subjects
			})
		errs = append(errs, fn(fldPath.Child("subjects"), obj.Subjects, oldVal, oldObj != nil)...)
	}
	...
	{ // field rbacv1alpha1.RoleBinding.RoleRef
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1alpha1.RoleBinding) *rbacv1alpha1.RoleRef {
				return &oldObj.RoleRef
			})
		errs = append(errs, fn(fldPath.Child("roleRef"), &obj.RoleRef, oldVal, oldObj != nil)...)
	}
...
func Validate_RoleRef(
	...
	{ // field rbacv1alpha1.RoleRef.Name
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1alpha1.RoleRef) *string {
				return &oldObj.Name
			})
...
func Validate_Subject(
	...
	{ // field rbacv1alpha1.Subject.Name
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1alpha1.Subject) *string {
				return &oldObj.Name
			})
		errs = append(errs, fn(fldPath.Child("name"), &obj.Name, oldVal, oldObj != nil)...)
	}
