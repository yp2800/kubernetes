...
func Validate_ClusterRole(
	...
	{ // field rbacv1.ClusterRole.Rules
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1.ClusterRole) []rbacv1.PolicyRule {
				return oldObj.Rules
			})
...
func Validate_ClusterRoleBinding(
	...
	{ // field rbacv1.ClusterRoleBinding.Subjects
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1.ClusterRoleBinding) []rbacv1.Subject {
...
func Validate_PolicyRule(
	...
	{ // field rbacv1.PolicyRule.Verbs
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1.PolicyRule) []string {
				return oldObj.Verbs
			})
...
func Validate_Role(
	...
	{ // field rbacv1.Role.Rules
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1.Role) []rbacv1.PolicyRule {
				return oldObj.Rules
			})
		errs = append(errs, fn(fldPath.Child("rules"), obj.Rules, oldVal, oldObj != nil)...)
	}
...
func Validate_RoleBinding(
	...
	{ // field rbacv1.RoleBinding.Subjects
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1.RoleBinding) []rbacv1.Subject {
				return oldObj.Subjects
			})
		errs = append(errs, fn(fldPath.Child("subjects"), obj.Subjects, oldVal, oldObj != nil)...)
	}
	...
	{ // field rbacv1.RoleBinding.RoleRef
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1.RoleBinding) *rbacv1.RoleRef {
				return &oldObj.RoleRef
			})
		errs = append(errs, fn(fldPath.Child("roleRef"), &obj.RoleRef, oldVal, oldObj != nil)...)
	}
...
func Validate_RoleRef(
	...
	{ // field rbacv1.RoleRef.Name
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1.RoleRef) *string {
				return &oldObj.Name
			})
...
func Validate_Subject(
	...
	{ // field rbacv1.Subject.Name
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *rbacv1.Subject) *string {
				return &oldObj.Name
			})
		errs = append(errs, fn(fldPath.Child("name"), &obj.Name, oldVal, oldObj != nil)...)
	}
